...
> Le contrôleur proportionnel est la première partie d'un **contrôleur PID** (proportionnel-intégral-dérivé) qui est une technique de contrôle plus avancée qui prend la somme de trois facteurs de correction pour ajuster la vitesse des moteurs. _Si ça vous intéresse_, vous pouvez consulter ces références pour plus d'information sur le contrôle PID : <a href="https://fll-pigeons.github.io/gamechangers/gyro_pid.html" target="_blank">Documentation d'une équipe FLL</a> _(plusieurs exemples de code pybricks et liens vers d'autres références)_; <a href="https://www.ctrlaltftc.com/the-pid-controller" target="_blank">Documentation d'une équipe FTC</a> _(explications approfondis avec diagrammes, mais exemples de code en Java)_.
